...
| 22a | POST | `/api/backtests/runs` | authenticated | `functions/api/routes/backtests.js` | APIClient |
| 22b | GET | `/api/backtests/runs` | authenticated | `functions/api/routes/backtests.js` | APIClient |
| 22c | GET | `/api/backtests/runs/:runId` | authenticated | `functions/api/routes/backtests.js` | APIClient |
| 22d | GET | `/api/backtests/tariff-plans` | authenticated | `functions/api/routes/backtests.js` | APIClient |
| 22e | POST | `/api/backtests/tariff-plans` | authenticated | `functions/api/routes/backtests.js` | APIClient |
| 22f | POST | `/api/backtests/tariff-plans/:planId` | authenticated | `functions/api/routes/backtests.js` | APIClient |
| 22g | DELETE | `/api/backtests/tariff-plans/:planId` | authenticated | `functions/api/routes/backtests.js` | APIClient |
